...
$('#drawInterval').addEventListener('change',async event=>{const room=await perform('room:configure',{drawInterval:Number(event.target.value)});if(room)applyRoom(room)});
